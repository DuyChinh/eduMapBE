...
class PDFParserService {
  constructor() {
    this.prompt = `
      ...
      6. XỬ LÝ ĐÁP ÁN: Hãy tìm Bảng Đáp Án (thường nằm ở cuối tài liệu hoặc cuối đoạn văn bản này).
         - Nếu tìm thấy bảng đáp án: Hãy gán 'isCorrect': true cho đáp án tương ứng và điền vào 'correctAnswer'.
         - Nếu KHÔNG tìm thấy bảng đáp án trong đoạn này: Hãy gán mặc định 'correctAnswer' là "A" và 'isCorrect': false cho tất cả. Đừng cố đoán mò.
      ...
      9. XỬ LÝ ĐÁP ÁN & LỜI GIẢI CHI TIẾT:
         ...
         - Nếu tìm thấy Bảng Đáp Án: Hãy dùng nó để điền 'correctAnswer'.
         - Phân biệt rõ "Câu hỏi" và "Lời giải". KHÔNG trích xuất nội dung của phần "Lời giải chi tiết" hay "Hướng dẫn giải" vào danh sách câu hỏi.
